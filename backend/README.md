...
## Project Structure
    ...
    ├── testapiautoconnecto_59768  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnecto_59768`
...
2. Clone this repo and `cd testapiautoconnecto_59768`
